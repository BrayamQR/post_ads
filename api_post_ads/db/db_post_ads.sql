...
-- Tiempo de generación: 15-06-2025 a las 21:19:00
...
CREATE TABLE IF NOT EXISTS `anuncio` (
  ...
  `nom_anunciante` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_distrito` int NOT NULL,
  `id_categoria` int NOT NULL,
  `id_tipo` int NOT NULL,
  `id_jornada` int DEFAULT NULL,
  `desc_corta` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `detall_anuncio` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `tiempo_publicacion` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `fecha_creacion` datetime NOT NULL,
  `fecha_publicacion` datetime DEFAULT NULL,
  `fecha_vencimiento` datetime DEFAULT NULL,
  `fecha_modificacion` datetime DEFAULT NULL,
  `tel_celular` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `whatsapp_contacto` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `email_contacto` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `link_referencia` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nro_operacion` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nom_titular` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `medio_operacion` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `img_comprobante` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `fecha_pago` datetime DEFAULT NULL,
  `monto_pago` decimal(10,2) DEFAULT NULL,
  `motivo_estado` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `id_usuario` int NOT NULL,
  `id_estado` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_anuncio`),
  UNIQUE KEY `nro_operacion` (`nro_operacion`),
...
CREATE TABLE IF NOT EXISTS `departamento` (
  ...
  `desc_departamento` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `departamento` (`id_departamento`, `desc_departamento`) VALUES
(1, 'Amazonas'),
(2, 'Ancash'),
(3, 'Apurimac'),
(4, 'Arequipa'),
...
CREATE TABLE IF NOT EXISTS `distrito` (
  ...
  `desc_distrito` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_provincia` int NOT NULL,
  PRIMARY KEY (`id_distrito`),
  KEY `id_provincia` (`id_provincia`)
) ENGINE=InnoDB AUTO_INCREMENT=1833 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `distrito`
--

INSERT INTO `distrito` (`id_distrito`, `desc_distrito`, `id_provincia`) VALUES
(1, 'Chachapoyas', 1),
(2, 'Asuncion', 1),
(3, 'Balsas', 1),
(4, 'Cheto', 1),
...
CREATE TABLE IF NOT EXISTS `provincia` (
  ...
  `desc_provincia` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_departamento` int NOT NULL,
  PRIMARY KEY (`id_provincia`),
  KEY `id_departamento` (`id_departamento`)
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `provincia`
--

INSERT INTO `provincia` (`id_provincia`, `desc_provincia`, `id_departamento`) VALUES
(1, 'Chachapoyas', 1),
(2, 'Bagua', 1),
(3, 'Bongara', 1),
(4, 'Condorcanqui', 1),
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `google_id` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `nom_usuario` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `ape_usuario` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  ...
  `pass_usuario` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `foto_usuario` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `email_verificado` tinyint(1) NOT NULL DEFAULT '0',
  `codigo_recuperacion` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `codigo_expira_en` datetime DEFAULT NULL,
  `id_tipousuario` int NOT NULL DEFAULT '0',
  `lvigente` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `usuario` (`id_usuario`, `google_id`, `nom_usuario`, `ape_usuario`, `user_name`, `email_usuario`, `pass_usuario`, `foto_usuario`, `email_verificado`, `codigo_recuperacion`, `codigo_expira_en`, `id_tipousuario`, `lvigente`) VALUES
(1, NULL, 'Admin', NULL, 'admin', 'chamos2407@gmail.com', '$2b$10$mppmLJ.qr5AjyXcrpdn2huUocr7bQadIfh7r0GD6B6LVyzHxdZS.m', NULL, 1, NULL, NULL, 1, 1),
(2, '112018744191053280108', 'Brayam', 'Quispe Ramos', '', 'brayam240795@gmail.com', NULL, '/uploads/photoperfil/1749703218484-25143989.jpg', 1, NULL, NULL, 0, 1),
(3, NULL, 'Brayam', 'Quispe Ramos', 'brayamq', 'chamos240795@gmail.com', '$2b$10$e/F0p5ILZuOmIBMeR1mJGud5t.HXqURcnIS3HQv13/4ywKeFVu3MC', '/uploads/photoperfil/1749875100705-206248876.jpg', 0, '306764', '2025-06-13 23:38:40', 0, 1);
...
--
ALTER TABLE `anuncio`
  ADD CONSTRAINT `anuncio_ibfk_1` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`) ON UPDATE CASCADE,
  ADD CONSTRAINT `anuncio_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON UPDATE CASCADE;
